...
| **livespec3** | Dev-tooling single-source convergence | `livespec-zs22.7.9` | ✅ **DONE** (convergence closed; the two decided follow-ups both CLOSED: `livespec-i05g` = bump-pin Option B, dt v0.28.1, fan-out verified across 4 consumers; `livespec-7a4e` = worktree pack → beads-fabro + console) | — (complete; handoff archived at `archive/prompts/dev-tooling-single-source-convergence-handoff.md`) |
