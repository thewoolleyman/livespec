...
>
> **Status of implementation:** cont. 5 is the DIRECTION + this plan write; the code fan-out (justfile `-n` logic in 4 repos + console Rust config→env) is the next step, plus closing the 6 concurrency PRs. See the cont. 5 STATUS report for what remains and the open interpretation.
>
