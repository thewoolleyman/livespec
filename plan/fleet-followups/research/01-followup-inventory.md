...
drift from the Session-3 `--since-version 150` pass). **NEXT CORE ACTION: run
`/livespec:revise`** to accept/reject both; do NOT re-file via `propose-change`. See
