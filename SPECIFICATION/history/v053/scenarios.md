...
This file enumerates the canonical user-facing scenarios for `livespec`: the happy-path seed/propose-change/revise/doctor flow, three error paths, and the recovery paths for seed, doctor, and pruning.
