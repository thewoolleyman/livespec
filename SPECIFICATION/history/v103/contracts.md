...
2. **Pluggable implementation.** The harness MUST drive the upstream `livespec`
   plugin in lockstep with one *impl* plugin (today `livespec-impl-beads`;
